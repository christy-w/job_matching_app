...
export class ProfileModal {
  ...
  initPreferenceArrays() {
	this.settings_steps = [
		...
		},
		{
			...
			fields: [
				{
					name_zh: "語言能力",
					name_en: "Language Abilities",
					type: "language_abilities",
					required: false,
					field_type: "multi_select", // input/select/multi_select/date/
					selection: '',
					options: []
	...
	this.update_info_model = {
		name_zh: "陳小珍",
		name_en: "Janet Chan",
		email: "janetchan@gmail.com",
		gender: "female",
		dob: "01-01-1990",
		district_id: 1,
		address: "",
		education_level: "post_secondary",
